...
Type_specifier : BasicType { AbsLua.Typespec $1 }
               ...
               | '{' '}' Type_specifier { AbsLua.Tarray $3 }
...
ComplexType : 'pointer' Type_specifier { AbsLua.Tpointer $2 }
Function_def :: { Function_def }
Function_def : 'function' Type_specifier Pident '(' Arguments ')' Chunk_stm 'end' { AbsLua.Func $2 $3 $5 $7 }
Arguments :: { Arguments }
Arguments : '(' ListArgument ')' { AbsLua.Parameters $2 }
Argument :: { Argument }
