...
data Type_specifier
    = Typespec BasicType
    | Typecompl ComplexType
    | Tarray Type_specifier
    | Tarraydef Integer Type_specifier
  deriving (Eq, Ord, Show, Read)
...
data ComplexType = Tpointer Type_specifier
  deriving (Eq, Ord, Show, Read)

data Function_def = Func Type_specifier Pident Arguments Chunk_stm
  deriving (Eq, Ord, Show, Read)

data Arguments = Parameters [Argument]
  deriving (Eq, Ord, Show, Read)
